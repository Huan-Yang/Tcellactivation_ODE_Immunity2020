...
patterns = [[], [3, 3], [1, 1], [3, 3, 1, 3], [1, 1, 1, 3, 3, 3], [
    1, 1, 1, 1, 1, 3, 3, 3], [6, 3, 1, 3], [3, 3, 3, 3, 1, 3], [6, 3, 1, 3, 1, 3]]
markers = ['o', 's', 'v', 'p', '8', 'D', '>', '^']
...
PlotSettings = namedtuple(
    'PlotSettings', ['patterns', 'markers', 'colors', 'w', 'h'])
ps_nb = PlotSettings(patterns=patterns, markers=markers,
                     colors=lcolors, w=w_im, h=h_im)
